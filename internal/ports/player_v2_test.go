...
func TestMakeGetPlayerV2Handler(t *testing.T) {
	t.Parallel()
	...
	t.Run("success", func(t *testing.T) {
		...
		getV2PlayerHandler := MakeGetPlayerV2Handler(func(ctx context.Context, uuid string) (*domain.PlayerPIT, error) {
			return player, nil
	...
	t.Run("player with all fields", func(t *testing.T) {
		...
		require.Contains(t, body, `"experience":2500`)
